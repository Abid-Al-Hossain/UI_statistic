...
export default function Page() {
  const [state, setState] = useState<StatisticState>(DEFAULT_STATISTIC_STATE);
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Statistic Studio" controls={controls} preview={output} /></AppShell>;
}
